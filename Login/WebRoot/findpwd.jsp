...
.btn2 {
  ...
  <body>
     <div class="top">
        ...
        <a href="${pageContext.request.contextPath}/index.jsp" style="color: #1E90FF; text-decoration: none;font-weight: bold;">返回登录</a>
    </div>
    <div class="t1" id="t1">
        <img src="img/anquanzhongxin.png" />
    </div>
    <div class="mid">
            ...
            <div id="m1" class="m1">
                <form name="form" method="post" id="f2">
                    <h2>找回人人网密码</h2><br /> 
                    请输入原有邮箱：&nbsp;&nbsp;<input placeholder="请输入用户名/邮箱" class="name" name="username" id="username" /><br /> 
                    请重新设置密码：&nbsp;&nbsp;<input type="password" placeholder="请输入不少于6位的密码" name="password" id="password" class="pwd" maxlength="15" /><br /> 
                    填写邮箱验证码：&nbsp;&nbsp;<input type="text" name="checknum" id="checknum" style="width:155px;height:40px;margin-top: 20px; ">
                    ...
                    <input type="button" value="完 成 密 码 重 置" onclick="regist()" class="btn2" id="btn2" /><br>
  ...
  <script type="text/javascript">
    function regist(){
        ...
        $.ajax({
                type: "POST",
                dataType: "json",
                url: "${pageContext.request.contextPath}/findPwd.action" ,//url
                data: $('#f2').serialize(),
		...
		if (username.value == '') {
  		...
  		if(boon==true) {
            ...
            var hander = setInterval(function() {
                ...
                type: "POST",
                dataType: "json",
                url: "${pageContext.request.contextPath}/sendFindCheckNum.action" ,//url
                data: $('#f2').serialize(),
                success:function(result){
                	console.log(result);
  					if (result.code == "succ") {
                		...
                		document.getElementById("sendmsg").innerHTML="您填写的用户名/邮箱不存在~";
                	}
                },
                error:function(){
                	alert("异常")
